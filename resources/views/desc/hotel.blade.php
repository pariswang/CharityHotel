...
<div class="page page--start" id="detail">
    <h1 class="page-title">“日月同城”医护酒店公寓平台-酒店支持</h1>
    ...
    <p class="text-center"><img src="{{asset('/imgs/hotle_qrcode.png')}}" alt=""></p>
    <h2 class="subtitle">第二：<a href="http://hotel_healthcare_support.dragongap.cn/download/%E9%85%92%E5%BA%97%E5%91%98%E5%B7%A5%E4%BD%BF%E7%94%A8%E6%89%8B%E5%86%8C.docx" target="_blank">点击此处</a>下载酒店用户手册</h2>
    <h2 class="subtitle">第三：参与在线培训后，扫描以下二维码进入系统开始注册和提交酒店资料</h2>
    <p class="text-center"><img src="{{asset('/imgs/hotle_enter_qrocde.png')}}" alt=""></p>
</div>
@endsection