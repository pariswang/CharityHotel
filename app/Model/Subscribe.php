...
class Subscribe extends Model
{
    ...
    protected $fillable = [
        'user_id', 'conn_person', 'conn_phone', 'checkin_num', 'date_begin', 'date_end', 'createdate', 'hotel_id', 'conn_position', 'conn_company', 'room_count', 'can_pay', 'has_letter', 'status', 'admin_id', 'region_id','hoteltaking_date','hide_status','spare_phone'
    ];
