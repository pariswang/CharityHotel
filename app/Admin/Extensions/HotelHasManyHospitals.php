 ...
 * @Last Modified time: 2020-02-29 23:05:53
 */
...
$('#has-many-{$this->column}').prev().prev().find('div:eq(0) h4').removeClass('pull-right');
$('#has-many-{$this->column}').prev().prev().find('div:eq(0) h4').addClass('pull-left');

$('#has-many-{$this->column}').prev().prev().find('div:eq(1)').html(hospitals_notice);
